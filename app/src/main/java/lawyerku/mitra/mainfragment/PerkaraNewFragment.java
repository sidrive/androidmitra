 ...
 * {@link PerkaraNewFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PerkaraNewFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PerkaraNewFragment extends Fragment {
     ...
     * @return A new instance of fragment PerkaraNewFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PerkaraNewFragment newInstance(String param1, String param2) {
        PerkaraNewFragment fragment = new PerkaraNewFragment();
...
//        lsbarang.setLayoutManager(layoutManager);
    ...
    private void getPerkara(RecyclerView lsperkara) {
        ...
        subscription.add(LawyerkuService.Factory.create().getProjectNew(accessToken)
