 ...
 * {@link PerkaraOnProgressFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PerkaraOnProgressFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PerkaraOnProgressFragment extends Fragment {
    ...
    public PerkaraOnProgressFragment() {
     ...
     * @return A new instance of fragment PerkaraOnProgressFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PerkaraOnProgressFragment newInstance(String param1, String param2) {
        PerkaraOnProgressFragment fragment = new PerkaraOnProgressFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_perkara_on_progress, container, false);
...
//        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext(),LinearLayoutManager.HORIZONTAL,false);
    ...
    private void getPerkara(RecyclerView lsperkara) {
        ...
        subscription.add(LawyerkuService.Factory.create().getDataProject(accessToken,"on-progress")
